function filename = generateSTLTestFilename(radius, height, orientation, center)
% GENERATESTLTESTFILENAME Encode geometric information in a parseable filename
%
% filename = GENERATESTLTESTFILENAME(R,H,O,C) creates a valid filename that encodes
%      the radius R, height H, orientation O and center C of an hexagonal prism.
%
